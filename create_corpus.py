...
def main():
    ...
    path_rir = cfg['rir_dir']  
    nr_samples = cfg['corpus_samples']
    sample_rate = cfg['sampling_rate']   #16000
    
    # Loads the csv containing the material index (from pyroomacoustics)
    mats_index = cfg['material_index']
    ...
    # Defining the class header for the final dataframe
    columns=['rir_file',
